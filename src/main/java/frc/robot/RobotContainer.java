...
public class RobotContainer {
    ...
    private void registerAllAutoCommands() {
        ...
        NamedCommands.registerCommand("ShootFromHandoff", //
            new ShootFromHandoff(shooterRotation, shooterWheels, servos, leds, () -> VisionVariables.ExportedVariables.Distance).until(shooterIRSensor::getBeamBroken));
    ...
    public void configureOperatorController() {
        ...
        operatorController.leftTrigger()
            .onTrue(
                new ParallelCommandGroup(
                    new RotateWristToPositionInfinite(wrist, IntakeConstants.WristPID.kWristOutOfTheWay),
                    new ShootFromHandoff(shooterRotation, shooterWheels, servos, leds, () -> VisionVariables.ExportedVariables.Distance))
                    .andThen(
                        new ParallelCommandGroup(
                            new ToggleRumble(driverController, 0.3),
