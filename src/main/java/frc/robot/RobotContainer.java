...
public class RobotContainer {
    ...
    autonChooser.addOption("Shoot and Scram",
        new SequentialCommandGroup(
            new ParallelDeadlineGroup(
                ...
                new SequentialCommandGroup(
                    new WaitCommand(0.7),
                    new ShootFromHandoff(wrist, shooterRotation, shooterWheels, servos, shooterIRSensor, leds))),
            // new Shoot(
            // shooterRotation,
            // shooterWheels, servos,
  ...
  private void configureDriverController() {
    ...
    driverController.x()
        .onTrue(new RotateShooterToPosition(shooterRotation,
            () -> LimelightUtils.GetSpeedAngle(VisionVariables.ExportedVariables.Distance).angle));
